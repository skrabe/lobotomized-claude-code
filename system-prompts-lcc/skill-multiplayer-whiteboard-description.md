...
description: >-
  Trigger description for the multiplayer Whiteboard skill, covering creation of
  a live shared canvas with synchronized strokes, cursors, session presence,
  pasted images, and Claude drawing
ccVersion: 2.1.261
-->
