<!--
name: 'Tool Description: Artifact How To Reopen Terminal'
description: >-
  Terminal-session Artifact tool-description fragment explaining /artifacts, o/c
  keys, ctrl+], and the web gallery when the user asks how to get back to their
  artifacts.
ccVersion: 2.1.281
-->
