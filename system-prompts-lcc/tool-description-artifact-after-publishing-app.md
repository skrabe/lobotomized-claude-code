<!--
name: 'Tool Description: Artifact After Publishing (App)'
description: >-
  Artifact tool description fragment for the in-app surface: gallery recovery
  and the post-publish card instead of a pasted URL.
ccVersion: 2.1.281
-->
