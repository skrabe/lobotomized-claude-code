<!--
name: 'Tool Parameter: Artifact session context guidance'
description: >-
  Guidance in the Artifact tool's session_context input-schema description
  listing what the model should preserve for later sessions.
ccVersion: 2.1.269
-->
