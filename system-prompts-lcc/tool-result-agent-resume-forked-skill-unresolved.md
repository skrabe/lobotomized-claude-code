...
-->
Agent ${TOOL_RESULT_AGENT_RESUME_FORKED_SKILL_UNRESOLVED_VAR_0} ran as forked skill ${TOOL_RESULT_AGENT_RESUME_FORKED_SKILL_UNRESOLVED_VAR_1.skillName}, which no longer resolves to a fork-capable skill; refusing to resume it without its permission scoping.
