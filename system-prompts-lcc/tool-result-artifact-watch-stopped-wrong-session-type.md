<!--
name: 'Tool Result: Artifact Re-Watch Denied In This Session Type'
description: >-
  Permission denial telling the model a stopped watch cannot be re-armed from a
  sub-agent, teammate, background, or print session.
ccVersion: 2.1.273
-->
