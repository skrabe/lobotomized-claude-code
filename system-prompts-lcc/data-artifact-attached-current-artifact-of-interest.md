...
variables:
  ...
  - DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_3
  - DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_4
-->
${DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_0}${DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_1}The user attached the artifact ${DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_2} to this session as the current artifact of interest. re-read it before editing or republishing (${DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_3()}).${DATA_ARTIFACT_ATTACHED_CURRENT_ARTIFACT_OF_INTEREST_VAR_4}
