<!--
name: Dir Sync Empty Start Could Not Check In
description: >-
  Model reminder that directory sync could not check in before the turn and the
  working directory is empty, so the user's files have not arrived yet.
ccVersion: 2.1.277
-->
