...
-->
The command was ${TOOL_RESULT_GETTASK_CANCELLED_OUTPUT_SO_FAR_VAR_0?TOOL_RESULT_GETTASK_CANCELLED_OUTPUT_SO_FAR_VAR_1[b]:"stopped before it completed"}. Output so far: ${TOOL_RESULT_GETTASK_CANCELLED_OUTPUT_SO_FAR_VAR_2}
