...
variables:
  ...
  - TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_2
-->
${TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_0.offline?TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_1:""}${TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_0.remoteNamesakeClaimedLocally?`; another session also named '${TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_0.displayName}' is registered to a session on this machine`:""}${TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_0.searchTruncated?TOOL_RESULT_SEND_MESSAGE_REMOTE_SESSION_IDENTITY_NOTES_VAR_2:""}
