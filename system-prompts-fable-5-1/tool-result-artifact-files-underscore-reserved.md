...
-->
files: published path ${TOOL_RESULT_ARTIFACT_FILES_UNDERSCORE_RESERVED_VAR_0.stringify(TOOL_RESULT_ARTIFACT_FILES_UNDERSCORE_RESERVED_VAR_1)} starts with "_", which the artifact service reserves for its own names — rename the file or its top-level directory
