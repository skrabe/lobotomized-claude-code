...
-->
runs the program a descriptor holds (${TOOL_RESULT_BASH_WORKTREE_ISOLATION_DESCRIPTOR_HOLDS_PROGRAM_VAR_0[K]}) ${TOOL_RESULT_BASH_WORKTREE_ISOLATION_DESCRIPTOR_HOLDS_PROGRAM_VAR_1}, so it cannot be shown not to be git
