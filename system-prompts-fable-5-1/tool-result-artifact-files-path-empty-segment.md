...
-->
${TOOL_RESULT_ARTIFACT_FILES_PATH_EMPTY_SEGMENT_VAR_0} ${TOOL_RESULT_ARTIFACT_FILES_PATH_EMPTY_SEGMENT_VAR_1(TOOL_RESULT_ARTIFACT_FILES_PATH_EMPTY_SEGMENT_VAR_2)} has an empty path segment
