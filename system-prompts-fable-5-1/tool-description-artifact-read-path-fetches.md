...
-->
 With \`path\`, it fetches ${TOOL_DESCRIPTION_ARTIFACT_READ_PATH_FETCHES_VAR_0.join(" or ")} instead and says where it put it${TOOL_DESCRIPTION_ARTIFACT_READ_PATH_FETCHES_VAR_1.multiFileOn?" (a small text file comes back inline, as data)":""}.
