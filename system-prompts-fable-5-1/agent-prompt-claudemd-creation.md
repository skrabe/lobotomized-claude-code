...
If there are Cursor rules (.cursor/rules/ or .cursorrules), Copilot rules (.github/copilot-instructions.md), or a README.md, fold in the important parts.${IS_IMPORT_ENABLED_FN()?`
