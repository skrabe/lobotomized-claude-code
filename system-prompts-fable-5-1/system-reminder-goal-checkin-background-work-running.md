...
-->
${SYSTEM_REMINDER_GOAL_CHECKIN_BACKGROUND_WORK_RUNNING_VAR_0} is still active, and evaluation has been deferred for ${SYSTEM_REMINDER_GOAL_CHECKIN_BACKGROUND_WORK_RUNNING_VAR_1} min because background work is still running:
