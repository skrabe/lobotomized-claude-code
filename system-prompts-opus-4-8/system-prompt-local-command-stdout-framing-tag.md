...
-->
<local-command-stdout>Running in the background as @${SYSTEM_PROMPT_LOCAL_COMMAND_STDOUT_FRAMING_TAG_VAR_0(SYSTEM_PROMPT_LOCAL_COMMAND_STDOUT_FRAMING_TAG_VAR_1(SYSTEM_PROMPT_LOCAL_COMMAND_STDOUT_FRAMING_TAG_VAR_2.name))}</local-command-stdout>
