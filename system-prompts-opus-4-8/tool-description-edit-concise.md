...
${TOOL_DESCRIPTION_EDIT_CONCISE_VAR_0?`
- If the file is outside the working directory, you must ${TOOL_DESCRIPTION_EDIT_CONCISE_VAR_1} it in this conversation before editing, or the call will fail.`:`
