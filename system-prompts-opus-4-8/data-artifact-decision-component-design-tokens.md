...
description: >-
  Provides the byte-pinned Claude Design System custom-property token block
  required by the reusable Artifact decision component
ccVersion: 2.1.232
-->
/* CDS token block for the decision component, carved VERBATIM from the
   ...
   test). Embed once per host page, before component.css. */
