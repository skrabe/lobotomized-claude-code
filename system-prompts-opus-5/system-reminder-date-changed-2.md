...
ccVersion: 2.1.251
variables:
  - SYSTEM_REMINDER_DATE_CHANGED_2_VAR_0
-->
The date has changed. Today's date is now ${SYSTEM_REMINDER_DATE_CHANGED_2_VAR_0.date}. No need to announce the new date — the user's own clock shows it.
