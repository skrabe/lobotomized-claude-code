...
description: >-
  Per-watch line in the watches tool result for a durable-wake subscription,
  naming its wake events and since time.
ccVersion: 2.1.239
variables:
  - TOOL_RESULT_ARTIFACT_DURABLE_WAKE_WATCHES_LIST_ITEM_VAR_0
  - TOOL_RESULT_ARTIFACT_DURABLE_WAKE_WATCHES_LIST_ITEM_VAR_1
  - TOOL_RESULT_ARTIFACT_DURABLE_WAKE_WATCHES_LIST_ITEM_VAR_2
  - TOOL_RESULT_ARTIFACT_DURABLE_WAKE_WATCHES_LIST_ITEM_VAR_3
-->
