...
description: >-
  Bundled template.html body fragment for the artifact-pr-review skill — the
  escaping rules, slots, decision islands and baked scripts the model copies and
  fills when publishing a review page.
ccVersion: 2.1.232
-->
