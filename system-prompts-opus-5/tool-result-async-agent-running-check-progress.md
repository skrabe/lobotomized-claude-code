...
-->
An instance is already running; don't spawn a duplicate. You'll be notified when it completes. Read partial output at ${TOOL_RESULT_ASYNC_AGENT_RUNNING_CHECK_PROGRESS_VAR_0} or message it with ${TOOL_RESULT_ASYNC_AGENT_RUNNING_CHECK_PROGRESS_VAR_1}.
