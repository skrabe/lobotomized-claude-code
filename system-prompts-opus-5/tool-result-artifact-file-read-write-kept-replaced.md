<!--
name: Artifact File Read Write Kept Replaced
description: >-
  file_read tool error when the earlier local copy was removed but the fetched
  file could not be moved into place.
ccVersion: 2.1.246
variables:
