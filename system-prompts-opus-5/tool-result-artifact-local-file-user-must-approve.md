...
-->
 The local file "${TOOL_RESULT_ARTIFACT_LOCAL_FILE_USER_MUST_APPROVE_VAR_0(TOOL_RESULT_ARTIFACT_LOCAL_FILE_USER_MUST_APPROVE_VAR_1.askPath,256)}" ${TOOL_RESULT_ARTIFACT_LOCAL_FILE_USER_MUST_APPROVE_VAR_2.join(" and ")}.
