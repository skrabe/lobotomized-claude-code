...
-->
Memory paths are absolute and start with "/" — use ${TOOL_RESULT_MEMORY_PATH_MUST_BE_ABSOLUTE_VAR_0(TOOL_RESULT_MEMORY_PATH_MUST_BE_ABSOLUTE_VAR_1)}.${TOOL_RESULT_MEMORY_PATH_MUST_BE_ABSOLUTE_VAR_2}
