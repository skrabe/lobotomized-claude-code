...
-->
Failed to start OAuth flow for ${TOOL_RESULT_MCP_OAUTH_FLOW_FAILED_VAR_0(TOOL_RESULT_MCP_OAUTH_FLOW_FAILED_VAR_1)}: ${TOOL_RESULT_MCP_OAUTH_FLOW_FAILED_VAR_2}. Ask the user to run /mcp and authenticate manually.
