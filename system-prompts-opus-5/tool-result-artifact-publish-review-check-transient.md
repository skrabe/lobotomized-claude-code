...
-->
publish refused: could not verify the target page is not a review page (transient read failure: ${TOOL_RESULT_ARTIFACT_PUBLISH_REVIEW_CHECK_TRANSIENT_VAR_0.err}). Retry the publish; if it persists, read the page (action: "read") to confirm it is reachable.
