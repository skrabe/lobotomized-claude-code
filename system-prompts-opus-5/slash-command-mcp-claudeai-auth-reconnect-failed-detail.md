...
-->
Tried reconnecting to ${SLASH_COMMAND_MCP_CLAUDEAI_AUTH_RECONNECT_FAILED_DETAIL_VAR_0.name}, but the connection failed: ${SLASH_COMMAND_MCP_CLAUDEAI_AUTH_RECONNECT_FAILED_DETAIL_VAR_1}
