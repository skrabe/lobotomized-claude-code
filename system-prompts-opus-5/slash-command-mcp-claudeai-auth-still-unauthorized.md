...
-->
Tried reconnecting, but ${SLASH_COMMAND_MCP_CLAUDEAI_AUTH_STILL_UNAUTHORIZED_VAR_0.name} is still unauthorized. Make sure the browser sign-in completed, then try again from /mcp.
