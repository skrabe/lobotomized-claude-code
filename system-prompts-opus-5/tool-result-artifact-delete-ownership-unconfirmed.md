...
-->
Couldn't confirm that the Artifact at ${TOOL_RESULT_ARTIFACT_DELETE_OWNERSHIP_UNCONFIRMED_VAR_0} is the user's own, so nothing was deleted. Retry once; if it still fails, ${TOOL_RESULT_ARTIFACT_DELETE_OWNERSHIP_UNCONFIRMED_VAR_1}
