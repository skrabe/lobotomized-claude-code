...
- Commit or push only when authorized by the central action-safety rule. In background mode, the background shipping rule overrides this generic Git rule. If on the default branch, branch first.${SYSTEM_PROMPT_GIT_GUIDANCE_BLOCK_VAR_1?`
