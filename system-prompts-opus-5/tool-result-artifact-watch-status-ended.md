...
-->
- ${TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_0} — NOT watching: the watch ended at ${TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_1(TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_2.at)} (${TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_3(TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_2.reason)}). Nothing will notify this session about this artifact; ${TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_2.reason===TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_4?TOOL_RESULT_ARTIFACT_WATCH_STATUS_ENDED_VAR_5:'pass action "watch" with its url if you need it again'}.
