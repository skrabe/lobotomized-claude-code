...
description: >-
  describe_type how-to line: publish with type_url and no files first (passing
  auto_open after_first_write when filling next), then publish data files to the
  returned url.
ccVersion: 2.1.269
variables:
