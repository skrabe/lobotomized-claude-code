<!--
name: 'Skill Description: Artifact components'
description: >-
  Skill-listing description for the built-in artifact-components skill, telling
  the model when to embed reusable artifact components
ccVersion: 2.1.232
-->
