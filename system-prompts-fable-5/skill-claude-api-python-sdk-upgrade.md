<!--
name: 'Skill: Claude API Python SDK Upgrade'
description: The claude-api skill's executable guide for upgrading a project from anthropic Python SDK 0.x to 1.x, invoked via /claude-api upgrade.
ccVersion: 2.1.239
-->
